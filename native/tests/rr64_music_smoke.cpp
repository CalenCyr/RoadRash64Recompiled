...
int main(int argc,char**argv){
    ...
    if(rr64_music_stock_volume(123)!=0||rr64_music_volume_update(0)!=1)return 5;
    rr64::music::playing.store(false);
    if(rr64_music_stock_volume(123)!=123||rr64_music_volume_update(0)!=1||rr64_music_volume_update(0)!=0)return 6;
