# Global Draw Distance candidate

Settings > Graphics > Draw Distance: 0–100%, step 5%, default 100%.
Replaces the split-screen-only slider and hides the legacy MAX World Distance
switch. No additional switch is required. MAX LOD remains independent.
